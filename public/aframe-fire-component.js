/**
 * A-Frame Fire Component by SirFizX
 * Adapted from Akihiro Oyamada's VolumetricFire.js
...
var VolumetricFire = window.Volumetricfire;

window.AFRAME.registerComponent('fire', {
    
      schema: {
        width: {type:'number', default: 2},
        height: {type:'number', default: 4},
        depth: {type:'number', default: 2},
        texturePath: {type:'string' , default:'./textures/'}
      },
    
      init: function () {
        VolumetricFire.texturePath = this.data.texturePath;
        let scene = document.querySelector('a-scene');
        let cam = scene.camera;
        this.fire = new VolumetricFire(this.data.width,this.data.height,this.data.depth,0.5,cam);
        this.el.setObject3D('mesh', this.fire.mesh);
      },
